# Terraform configuration for deploying go-gameserver to AWS ECS Fargate
# with an RDS PostgreSQL database and Application Load Balancer.
#
# Usage:
#   cd deploy/aws
#   terraform init
...
resource "aws_ecs_task_definition" "main" {
  ...
  container_definitions = jsonencode([{
    ...
    environment = [
      ...
      { name = "DB_DSN", value = "host=${aws_db_instance.main.address} user=gameserver password=${var.db_password} dbname=gameserver port=5432 sslmode=require" },
    ]
